...
public class XmlDeepToMap {
	public static void main(String[] args) throws DocumentException {
		...
		System.out.println(xmlToMap);//{bbb=fdffffffff, ORDER_ID=20181025153649, ddd=1245}
	}
	...
	@SuppressWarnings("unchecked")
	private static Map<String, String> xmlDeepToMapGetAllElements(List<Element> childElements, Map<String, String> mapElement) {
